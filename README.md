...
> **How this works:** The deploy command serves `public/` as static assets and automatically picks up `functions/` at the project root for the Pages Function (`/api/calendar`). No build step is needed — match data is pre-generated by GitHub Actions and committed to the repo.
